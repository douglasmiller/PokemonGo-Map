...
function setupPokemonMarker(item, skipNotification, isBounceDisabled) {
  ...
  marker.infoWindow = new google.maps.InfoWindow({
    content: pokemonLabel(idToPokemon[item.pokemon_id].name, item.pokemon_rarity, item.pokemon_types, item.disappear_time, item.pokemon_id, item.latitude, item.longitude, item.encounter_id),
    disableAutoPan: true
  });
